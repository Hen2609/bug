    ...
    function ensure(state, propertyName) {
      ...
      if (!(propertyName in proto)) {
        Object.defineProperty(proto, propertyName, {
          ...
          set: function(value) {
            this.___set(propertyName, value, false);
          }
        });
      }
    }
    ...
    EventEmitterWrapper.prototype = {
      ...
      once: function(event, listener) {
        ...
        var wrappedListener = function() {
          self.$__remove(function(event2, listenerFunc) {
...
var require_update_manager = __commonJS({
  "node_modules/marko/src/runtime/components/update-manager.js"(exports) {
    ...
    var batchStack = [];
    var unbatchedQueue = [];
    var setImmediate = require_index_browser2().___setImmediate;
    ...
    Component.prototype = componentProto = {
      ...
      getEl: function(key, index) {
        if (key) {
          ...
          if ("MARKO_DEBUG") {
            if (keyedElement && keyedElement.nodeType !== 1) {
              throw new Error(
        ...
        if (typeof name == "object") {
          ...
          for (var k in newState) {
            if (hasOwnProperty.call(newState, k)) {
              state.___set(k, newState[k], true);
            }
          }
        } else {
          state.___set(name, value, true);
        }
      },
      ...
      get els() {
        ...
        return (this.___rootNode ? this.___rootNode.nodes : []).filter(function(el) {
...
//# sourceMappingURL=chunk-3MO5ZOMD.js.map
